...
The results of the \textbf{three steps} are presented on a real data: 
\begin{enumerate}
...
\end{enumerate}
Even though we chose to present it in this order, note that the first and second steps are independant. We could have chosen to start the presentation with the clustering results. 
